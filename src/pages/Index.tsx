...
export default function Index() {
  ...
  return (
    <div className="bg-white text-corp-dark font-body min-h-screen">

      {/* NAV */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b border-corp-steel">
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-16">
          <div className="font-heading text-2xl font-bold tracking-widest text-corp-dark">
          ...
          <a
            href="#contact"
            className="hidden md:block bg-corp-gold hover:bg-corp-gold-light text-white font-heading font-semibold text-sm px-5 py-2 tracking-wider uppercase transition-colors"
          >
            Заявка
          </a>
          <button
            className="md:hidden text-corp-dark"
        ...
        {menuOpen && (
          <div className="md:hidden bg-white border-t border-corp-steel px-6 py-4 flex flex-col gap-4">
            {NAV_LINKS.map((l) => (
              <a
                key={l.href}
                href={l.href}
            ...
            <a
              href="#contact"
              onClick={() => setMenuOpen(false)}
              className="bg-corp-gold text-white font-heading font-semibold text-sm px-5 py-2 tracking-wider uppercase text-center"
            >
              Оставить заявку
            </a>
          </div>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden pt-16">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-corp-dark/95 via-corp-dark/80 to-corp-dark/50" />

        <div className="relative z-10 max-w-7xl mx-auto px-6 py-24">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 border border-corp-gold/60 bg-corp-gold/10 px-4 py-1.5 mb-8">
            ...
            <h1 className="font-heading text-5xl md:text-7xl font-bold leading-tight mb-6 text-white animate-fade-up">
              БОЛЬШЕ ПРОДАЖ<br />
              <span className="text-corp-gold">АВТО И ТЕХНИКИ</span><br />
              ИЗ ЛЮБОЙ ТОЧКИ МИРА
            </h1>

            <p className="text-white/80 text-lg md:text-xl mb-10 leading-relaxed max-w-xl animate-fade-up" style={{ animationDelay: "0.15s" }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-fade-up" style={{ animationDelay: "0.3s" }}>
              <a
                href="#contact"
                className="bg-corp-gold hover:bg-corp-gold-light text-white font-heading font-bold text-base px-8 py-4 tracking-wider uppercase transition-all hover:scale-105 text-center"
              >
                Получить стратегию
              </a>
              <a
                href="#cases"
                className="border border-white/50 hover:border-corp-gold text-white hover:text-corp-gold font-heading font-medium text-base px-8 py-4 tracking-wider uppercase transition-all text-center"
              >
                Смотреть кейсы
              </a>
            </div>
      ...
      <section id="services" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-14">
            ...
            <h2 className="font-heading text-4xl md:text-5xl font-bold mt-3 text-corp-dark">
              УСЛУГИ ДЛЯ<br />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-corp-steel">
            {SERVICES.map((s) => (
              <div
                key={s.title}
                className="bg-white p-8 hover:bg-corp-navy transition-colors group"
              >
                <div className="w-12 h-12 border-2 border-corp-gold/30 flex items-center justify-center mb-5 group-hover:border-corp-gold transition-colors">
                  <Icon name={s.icon} size={22} className="text-corp-gold" />
                </div>
                <h3 className="font-heading text-xl font-semibold text-corp-dark mb-3 tracking-wide">
                  {s.title}
                </h3>
      ...
      {/* CASES */}
      <section id="cases" className="py-24 bg-corp-navy">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-14">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {CASES.map((c) => (
              <div
                key={c.company}
                className="bg-white p-10 border border-corp-steel relative overflow-hidden group hover:border-corp-gold transition-colors"
              >
                <div className="absolute top-0 right-0 w-40 h-40 bg-corp-gold/5 rounded-full -translate-y-1/2 translate-x-1/2" />
                <div className="relative z-10">
                  <span className="inline-block bg-corp-gold text-white text-xs font-medium tracking-widest uppercase px-3 py-1 mb-4">
                    {c.tag}
                  </span>
                  <h3 className="font-heading text-3xl font-bold text-corp-dark mb-1">{c.company}</h3>
                  ...
                  <div className="flex gap-8 mb-7">
                    ...
                    <div className="w-px bg-corp-steel" />
                    <div>
                  ...
                  <p className="text-corp-silver text-sm leading-relaxed">{c.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* HOW WE WORK */}
      <section className="py-24 bg-corp-dark">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-14">
            <span className="text-corp-gold text-xs font-medium tracking-widest uppercase">Процесс</span>
            <h2 className="font-heading text-4xl md:text-5xl font-bold mt-3 text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0">
            {HOW_WE_WORK.map((step) => (
              <div key={step.num} className="relative group">
                <div className="p-8 border-l border-white/10 hover:border-corp-gold transition-colors h-full">
                  <div className="font-heading text-5xl font-bold text-white/10 group-hover:text-corp-gold/30 transition-colors mb-4">
                    {step.num}
                  </div>
                  <h3 className="font-heading text-lg font-semibold text-white mb-3 tracking-wide">
                    {step.title}
                  </h3>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="font-heading text-4xl md:text-5xl font-bold mt-3 mb-6 text-corp-dark">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-corp-gold p-6 hidden lg:block">
                <div className="font-heading text-3xl font-bold text-white">7+</div>
                <div className="text-white text-xs font-semibold mt-1">лет<br />экспертизы</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {ADVANTAGES.map((a) => (
              <div
                key={a.title}
                className="flex gap-6 p-8 bg-white border border-corp-steel hover:border-corp-gold transition-colors group"
              >
                <div className="w-14 h-14 border-2 border-corp-gold/30 flex items-center justify-center flex-shrink-0 group-hover:border-corp-gold transition-colors bg-corp-gold/5">
                  <Icon name={a.icon} size={24} className="text-corp-gold" />
                </div>
                <div>
                  <h3 className="font-heading text-xl font-semibold text-corp-dark mb-2 tracking-wide">
                    {a.title}
                  </h3>
      ...
      <section id="contact" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              ...
              <div className="flex flex-col gap-5">
                {[
                  ...
                  <div key={c.icon} className="flex items-center gap-4">
                    <div className="w-10 h-10 border-2 border-corp-gold/30 bg-corp-gold/5 flex items-center justify-center">
            ...
            <div>
              {submitted ? (
                <div className="border-2 border-corp-gold bg-corp-gold/5 p-12 flex flex-col items-center justify-center text-center h-full min-h-80">
                  <Icon name="CheckCircle" size={48} className="text-corp-gold mb-4" />
                  <h3 className="font-heading text-2xl font-bold text-corp-dark mb-2">Заявка отправлена!</h3>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-corp-navy border border-corp-steel focus:border-corp-gold text-corp-dark px-4 py-3 text-sm outline-none transition-colors placeholder:text-corp-mid"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-corp-navy border border-corp-steel focus:border-corp-gold text-corp-dark px-4 py-3 text-sm outline-none transition-colors placeholder:text-corp-mid resize-none"
                  ...
                  <button
                    type="submit"
                    className="bg-corp-gold hover:bg-corp-gold-light text-white font-heading font-bold text-sm px-8 py-4 tracking-widest uppercase transition-all hover:scale-[1.02] w-full"
                  >
      ...
      {/* FOOTER */}
      <footer className="bg-corp-dark border-t border-white/10 py-10">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-6 flex-wrap justify-center">
            {NAV_LINKS.map((l) => (
              <a key={l.href} href={l.href} className="text-white/30 hover:text-corp-gold text-xs tracking-wide uppercase transition-colors">
                {l.label}
              </a>
            ))}
          </div>
